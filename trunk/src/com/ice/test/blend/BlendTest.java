...
import com.ice.graphics.state_controller.BlendController;
 ...
 * Date: 13-2-12
 */
public class BlendTest extends TestCase {
    ...
    private class Renderer extends AbstractRenderer {
        ...
        protected void onCreated(EGLConfig config) {
            ...
            geometryA.setFragmentShader(fsh);
            ...
            geometryB.setFragmentShader(fsh);
